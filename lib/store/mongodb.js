...
function MongoDbAdapter(logger, opts) {
    ...
    self.settings = {
        ...
        connectionUrl: opts.rs || process.env["MONGODB_URI"] || opts.url || process.env["DB_URL"],
        ...
        mongoDbOpts: _.assign({retryWrites: false, useNewUrlParser: true, promiseLibrary: RSVP.Promise}, opts)
    };
