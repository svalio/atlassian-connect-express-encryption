            ...
            function (error, response, schema) {
                ...
                if (statusCode < 200 || statusCode > 299) {
                    ...
                    validator.validateDescriptor(self.descriptor, schema, function (errors, warnings) {
                        ...
                        if (results.length > 0) {
                            self.logger.info('Error validating app descriptor: [' + JSON.stringify(results, null, 2) + '] . Please check and resolve the problem/s. The app will still continue to run but there might be problems installing this in ' + productName);
                        } else {
                            self.logger.info('App descriptor passed validator');
                        }
                    })
                }
