...
The project generated by atlas-connect is configured to use a file-based SQLite database. It's a quick way to get started, but not recommended for production. In order to use it, you need to install it with:

    npm install --save-dev jugglingdb-sqlite3
